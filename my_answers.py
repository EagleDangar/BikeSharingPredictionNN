...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        # print(" final_outputs of error {} - y shape {} - x -shape {} ".format(final_outputs.shape, y.shape, X.shape))

        # TODO: Output error - Replace this value with your calculations.
        error =  y - final_outputs # Output layer error is the difference between desired target and actual output.
        # print(" shape of error {} , {}".format(error.shape , error))
        
        # TODO: Calculate the hidden layer's contribution to the error
        hidden_error = np.dot(self.weights_hidden_to_output, error)
        # print(" shape of hidden_error {} - {}".format(hidden_error.shape, hidden_error))
        
        # TODO: Backpropagated error terms - Replace these values with your calculations.
        output_error_term = error
        # print(" shape of output_error_term {} - {}".format(output_error_term.shape,output_error_term))
        
        hidden_error_term = hidden_error * hidden_outputs * (1 - hidden_outputs)
        # print(" shape of hidden_error_term {} - hidden_error_term".format(hidden_error_term.shape, hidden_error_term))
